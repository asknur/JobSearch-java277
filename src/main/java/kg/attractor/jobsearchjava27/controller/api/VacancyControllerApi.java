...
//    @PostMapping
//    public ResponseEntity<Vacancy> createVacancy(@RequestBody VacancyDto vacancy) {
//        return new  ResponseEntity<>(vacancyService.create(vacancy);, HttpStatus.OK);
//    }
//
//    @PutMapping("/{id}")
//    public ResponseEntity<Vacancy> updateVacancy(@PathVariable int id, @RequestBody Vacancy vacancy) {
//        vacancy.setId(id);
//        return new ResponseEntity<>(vacancyService.update(vacancy), HttpStatus.OK);
//    }
